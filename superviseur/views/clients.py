...
from superviseur.forms                   import ClientForm
...
def list_clients(request):
    ...
    form = ClientForm()
    return render(request, 'pages/clients/list_client.html', {'clients': clients, 'form': form})
...
def add_client(request):
    ...
    clients = Client.objects.all()
    return render(request, 'pages/clients/list_client.html', {'form': form, 'clients': clients, 'show_modal': show_modal})
...
def update_client(request, pk):
    ...
    return render(request, 'pages/clients/list_client.html', {'form': form, 'clients': Client.objects.all()})
