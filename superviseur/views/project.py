...
from superviseur.forms               import ProjectForm
from superviseur.forms               import ParcelleForm
from superviseur.forms               import NodeForm
...
def add_project(request):
    ...
    response = render(request, 'pages/project.html', {
        'form': form,
