document.addEventListener('DOMContentLoaded', function() {
    window.onload = function() {
        ...
        L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_satellite/{z}/{x}/{y}{r}.jpg?api_key=5d258c13-f5d1-432d-a740-b520128cad3e', {}).addTo(map);
        ...
        function loadParcelsOnDisplayMap(projectId) {
            ...
            L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_satellite/{z}/{x}/{y}{r}.jpg?api_key=5d258c13-f5d1-432d-a740-b520128cad3e', {}).addTo(displayMap);
            ...
            function loadParcelsOnCustomDisplayMap(projectId) {
                ...
                L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_satellite/{z}/{x}/{y}{r}.jpg?api_key=5d258c13-f5d1-432d-a740-b520128cad3e', {}).addTo(customDisplayMap);
